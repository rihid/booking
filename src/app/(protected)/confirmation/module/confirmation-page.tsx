...
function ConfirmationPage({
  ...
  const getTransactionStatus = () => {
    // axios.get(process.env.NEXT_PUBLIC_MIDTRANS_API + '/v2/' + orderId + '/status', {
    //   headers: {
    //     accept: 'application/json',
    //     authorization: 'Basic U0ItTWlkLXNlcnZlci1mandjaU5HSjhNS2s3UGxfa3lPb3JtclY6'
    //   }
    // }).then(response => {
    ...
    // fetch(`https://api.sandbox.midtrans.com/v2/${orderId}/status`, {
    //   method: 'GET',
    //   mode: 'no-cors',
    //   headers: {
    //     accept: 'application/json',
