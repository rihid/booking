...
import { MapPin, Clock, Star, Check, Camera, CupSoda, Bath, ChevronLeft, Share2 } from 'lucide-react';
...
import { getSingleProductPublic } from '@/lib/data';

async function Detail({
  params: { id } //getting param in ssr
}: {
  params: { id: string }
}) {
          ...
          <Card className="my-4">
            <CardContent className="p-3 flex items-center justify-between">
              <div className="flex items-center text-foreground/50 gap-x-2">
                ...
                <span className="font-normal text-xs">Duration {product.duration_trip} Miliseconds</span>
              </div>
