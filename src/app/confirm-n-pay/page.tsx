        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-start justify-between w-full">
            ...
            <ToggleGroup type="multiple" className="mt-3">
              <ToggleGroupItem
                value="drone"
                className="mr-8 border border-brand rounded px-4 py-2 text-xs font-normal font-foreground/50"
              >
                Drone
              </ToggleGroupItem>
              <ToggleGroupItem
                value="food"
                className="mr-8 rounded px-4 py-2 text-xs font-normal font-foreground/50"
              >
                Food
              </ToggleGroupItem>
              <ToggleGroupItem
        ...
        <div>
          ...
          <div className="space-y-6">
            <ToggleGroup type="single" className="flex flex-col w-full gap-5">
              <ToggleGroupItem
                value="credit-debit"
                className="border border-foreground/50 rounded px-4 py-3 text-xs text-start font-normal font-foreground/50"
              >
